...
// Package bind generates Filestorm contract Go bindings.
//
// Detailed usage document and tutorial available on the go-filestorm Wiki page:
// https://github.com/filestorm/go-filestorm/wiki/Native-DApps:-Go-bindings-to-Filestorm-contracts
package bind
