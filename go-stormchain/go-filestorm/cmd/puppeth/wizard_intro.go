...
// setting up a new or managing an existing Filestorm private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Filestorm private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Filestorm network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and fststats servers |")
	...
	log.Info("Administering Filestorm network", "name", w.network)
