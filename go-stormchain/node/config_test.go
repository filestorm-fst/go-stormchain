...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "storm.ipc", false, filepath.Join(os.TempDir(), "storm.ipc")},
		{"data", "storm.ipc", false, "data/storm.ipc"},
		{"data", "./storm.ipc", false, "./storm.ipc"},
		{"data", "/storm.ipc", false, "/storm.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "storm.ipc", true, `\\.\pipe\storm.ipc`},
		{"data", "storm.ipc", true, `\\.\pipe\storm.ipc`},
		{"data", `\\.\pipe\storm.ipc`, true, `\\.\pipe\storm.ipc`},
	}
