...
// mapped from textual names used in the tests below to actual StormChain private
...
// address retrieves the StormChain address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the StormChain address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/filestorm-fst/go-stormchain/issues/17593). Whilst this
