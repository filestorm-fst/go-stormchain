...
// ecrecover extracts the StormChain account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the StormChain address
...
// StormChain testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // StormChain address of the signing key
...
// Author implements consensus.Engine, returning the StormChain address recovered
