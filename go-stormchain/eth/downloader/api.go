...
// Syncing provides information when this nodes starts synchronising with the StormChain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  stormchain.SyncProgress `json:"status"`
}
