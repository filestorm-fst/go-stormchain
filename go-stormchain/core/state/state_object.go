...
// stateObject represents an StormChain account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of stormchain address of the account
	data     Account
	db       *StateDB
...
// Account is the StormChain consensus representation of accounts.
