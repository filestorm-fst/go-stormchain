...
// Package graphql provides a GraphQL interface to StormChain node data.
package graphql
...
// Account represents an StormChain account at a particular block.
type Account struct {
...
// Transaction represents an StormChain transaction.
...
// Block represents an StormChain block.
...
type CallData struct {
	From     *common.Address // The StormChain address the call is from.
	To       *common.Address // The StormChain address the call is to.
...
type SyncState struct {
	progress stormchain.SyncProgress
}
