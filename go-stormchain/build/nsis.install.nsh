...
!define HELPURL "https://github.com/filestorm-fst/go-stormchain/issues"
!define UPDATEURL "https://github.com/filestorm-fst/go-stormchain/releases"
!define ABOUTURL "https://github.com/filestorm-fst/go-stormchain#stormchain-go"
...
Section "Geth" GETH_IDX
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\storm.exe" "" "" "StormChain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\storm.exe" "" "" "StormChain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\storm.exe" "" "" "StormChain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/stormchain/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\storm.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\storm.ipc"
