...
var (
	...
	skipPrefixes = []string{
		...
		"crypto/secp256k1", // Relicensed to BSD-3 via https://github.com/filestorm-fst/go-stormchain/pull/17225
	}
	...
	authorsFileHeader = "# This is the official list of go-stormchain authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-stormchain Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-stormchain"
	}
	if startOfSentence {
		return "The go-stormchain library"
	}
	return "the go-stormchain library"
}
