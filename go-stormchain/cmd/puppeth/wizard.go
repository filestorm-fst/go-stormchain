...
type wizard struct {
	...
	services map[string][]string   // StormChain services known to be running on servers
...
// converts it to an StormChain address. If an empty line is entered, the default
// value is returned.
