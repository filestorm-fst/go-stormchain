...
import (
	...
	math2 "github.com/filestorm-fst/go-stormchain/common/math"
...
// newAlethGenesisSpec converts a go-stormchain genesis block into a Aleth-specific
// chain specification format.
func newAlethGenesisSpec(network string, genesis *core.Genesis) (*alethGenesisSpec, error) {
	// Only ethash is currently supported between go-stormchain and aleth
...
type parityChainSpecPricing struct {
	...
	// Before the https://github.com/paritytech/parity-stormchain/pull/11039,
...
// newParityChainSpec converts a go-stormchain genesis block into a Parity specific
// chain specification format.
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	// Only ethash is currently supported between go-stormchain and Parity
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
	...
	// https://github.com/stormchain/EIPs/blob/master/EIPS/eip-608.md
	spec.Params.EIP150Transition = hexutil.Uint64(genesis.Config.EIP150Block.Uint64())

	// Spurious Dragon: 155, 160, 161, 170
	// https://github.com/stormchain/EIPs/blob/master/EIPS/eip-607.md
	...
	spec.Genesis.Seal.StormChain.Nonce = types.EncodeNonce(genesis.Nonce)
	spec.Genesis.Seal.StormChain.MixHash = (genesis.Mixhash[:])
	spec.Genesis.Difficulty = (*hexutil.Big)(genesis.Difficulty)
	spec.Genesis.Author = genesis.Coinbase
	spec.Genesis.Timestamp = (hexutil.Uint64)(genesis.Timestamp)
	spec.Genesis.ParentHash = genesis.ParentHash
...
// pyStormChainGenesisSpec represents the genesis specification format used by the
// Python StormChain implementation.
type pyStormChainGenesisSpec struct {
	Nonce      types.BlockNonce  `json:"nonce"`
	Timestamp  hexutil.Uint64    `json:"timestamp"`
	ExtraData  hexutil.Bytes     `json:"extraData"`
	GasLimit   hexutil.Uint64    `json:"gasLimit"`
...
// newPyStormChainGenesisSpec converts a go-stormchain genesis block into a Parity specific
// chain specification format.
func newPyStormChainGenesisSpec(network string, genesis *core.Genesis) (*pyStormChainGenesisSpec, error) {
	// Only ethash is currently supported between go-stormchain and pystormchain
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
	spec := &pyStormChainGenesisSpec{
