...
// setting up a new or managing an existing StormChain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your StormChain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new StormChain network down to  |")
	...
	log.Info("Administering StormChain network", "name", w.network)
