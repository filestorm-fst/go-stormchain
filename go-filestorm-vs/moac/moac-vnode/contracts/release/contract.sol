...
// ReleaseOracle is an MoacNode contract to store the current and previous
// versions of the MOAC-core implementation. Its goal is to allow Moac to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new Moac releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular Moac release
  struct Version {
  ...
  // updateSigner marks a vote for changing the status of an MoacNode user, either
