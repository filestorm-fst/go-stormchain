...
// Package chequebook package wraps the 'chequebook' MoacNode smart contract.
//
...
import (
	...
	"github.com/filestorm/go-filestorm/moac/moac-vnode/contracts/chequebook/contract"
	...
	"github.com/filestorm/go-filestorm/moac/moac-vnode/swarm/services/swap/swap"
)
...
// Cash cashes the cheque by sending an MoacNode transaction.
