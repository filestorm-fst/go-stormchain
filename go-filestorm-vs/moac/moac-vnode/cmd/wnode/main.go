...
import (
	...
	"github.com/filestorm/go-filestorm/moac/moac-vnode/whisper/mailserver"
	whisper "github.com/filestorm/go-filestorm/moac/moac-vnode/whisper/whisperv5"
...
func startServer() {
	...
	fmt.Println(p2pServer.NodeInfo().Enode)
...
func waitForConnection(timeout bool) {
	...
	for !connected {
		...
		connected = p2pServer.PeerCount() > 0
		if timeout {
			cnt++
			if cnt > 1000 {
