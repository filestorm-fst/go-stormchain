...
// Tests that initializing Moac with a custom genesis block and chain definitions
// work properly.
func TestCustomGenesis(t *testing.T) {
	for i, tt := range customGenesisTests {
		...
		runMoac(t, "--datadir", datadir, "init", json).WaitExit()
