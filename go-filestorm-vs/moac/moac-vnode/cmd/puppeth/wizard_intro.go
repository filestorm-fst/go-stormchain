...
// setting up a new or managing an existing MoacNode private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your MoacNode private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new MoacNode network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and mcstats servers |")
	...
	log.Info("Administering MoacNode network", "name", w.network)
