...
import (
	...
	"github.com/filestorm/go-filestorm/moac/moac-lib/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the MoacNode contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the MoacNode contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the MoacNode contract Solidity source to build and bind")
