...
// Package Moaccore defines interfaces for interacting with MoacNode.
package moaccore
...
type CallMsg struct {
	...
	GasLimit *big.Int        // if nil, the call executes with near-infinite gas
	GasPrice *big.Int        // sha <-> gas exchange ratio
	Value    *big.Int        // amount of sha sent along with the call
