...
!define HELPURL "https://github.com/filestorm/go-filestorm/moac/moac-vnode/issues"
!define UPDATEURL "https://github.com/filestorm/go-filestorm/moac/moac-vnode/releases"
!define ABOUTURL "https://github.com/filestorm/go-filestorm/moac/MoacCore#moac"
...
Section "Moac" MOAC_IDX
  ...
  SimpleFC::AdvRemoveRule "Moac incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Moac outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Moac UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Moac incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "MoacNode" 30303 "" "" ""
  SimpleFC::AdvAddRule "Moac outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "MoacNode" "" 30303 "" ""
  SimpleFC::AdvAddRule "Moac UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "MoacNode" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\moac.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\moac.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${MOAC_IDX}
    SectionGetSize ${MOAC_IDX} $0
