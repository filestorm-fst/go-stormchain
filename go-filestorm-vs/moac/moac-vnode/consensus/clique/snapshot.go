...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db mcdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db mcdb.Database) error {
