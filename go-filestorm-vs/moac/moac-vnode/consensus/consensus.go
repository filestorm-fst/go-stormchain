...
// Package consensus implements different MoacNode consensus engines.
package consensus
...
type Engine interface {
	// Author retrieves the MoacNode address of the account that minted the given
	...
	Finalize(chain ChainReader, header *types.Header, state *state.StateDB, txs []*types.Transaction,
		uncles []*types.Header, receipts []*types.Receipt, liveFlag bool) (*types.Block, error)
