...
func (c *cache) generate(dir string, limit int, test bool) {
	log.Debug("cache/generate", "dir", dir, "limit", limit, "test", test)
	c.once.Do(func() {
...
func (d *dataset) generate(dir string, limit int, test bool) {
	log.Debug("dataset/generate", "dir", dir, "limit", limit, "test", test)
	d.once.Do(func() {
...
// all blocks' seal as valid, though they still have to conform to the MoacNode
// consensus rules.
...
// still have to conform to the MoacNode consensus rules.
...
// they still have to conform to the MoacNode consensus rules.
...
func (ethash *Ethash) dataset(block uint64) []uint32 {
	...
	log.Debug("Ethash/dataset", "epoch", epoch)
	if current == nil {
