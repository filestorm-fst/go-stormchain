...
contract VnodeProtocolBase {
    ...
    function withdraw() public {
	    ...
	    vnodeStore[index].rpclink = vnodeStore[vnodeCount].rpclink;
	    vnodeStore[index].via = vnodeStore[vnodeCount].via;
    ...
    function sweepOutage(uint level, uint startpos, uint count) public {
		...
		vnodeStore[i].rpclink = vnodeStore[vnodeCount].rpclink;
		vnodeStore[i].via = vnodeStore[vnodeCount].via;
