...
func NewEVMContext(msg Message, header *types.Header, chain ChainContext, author *common.Address, txpool *TxPool) vm.Context {
...
func Transfer(db vm.StateDB, sender common.Address, recipient common.Address, amount *big.Int) {
