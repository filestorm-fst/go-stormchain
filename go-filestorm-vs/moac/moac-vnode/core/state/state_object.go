...
// stateObject represents an MoacNode account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of moac address of the account
	data     Account
	db       *StateDB
...
// Account is the MoacNode consensus representation of accounts.
...
func (self *stateObject) StateChgStringToObject(jsonBytes []byte) (dump types.AccountChgDump, err error) {
	err = json.Unmarshal(jsonBytes, &dump)
	return dump, err
}
