...
func makeTestState() (Database, *mcdb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := mcdb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db mcdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db mcdb.Database, root common.Hash) error {
...
func checkStateConsistency(db mcdb.Database, root common.Hash) error {
