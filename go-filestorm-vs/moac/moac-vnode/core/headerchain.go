...
func NewHeaderChain(chainDb mcdb.Database, config *params.ChainConfig, engine consensus.Engine, procInterrupt func() bool) (*HeaderChain, error) {
...
func (hc *HeaderChain) InsertHeaderChain(chain []*types.Header, writeHeader WhCallback, start time.Time) (int, error) {
	...
	log.Infof("Imported new block headers count=%v elapsed=%v number=%v, hash=%v, ignored=%v", stats.processed, common.PrettyDuration(time.Since(start)),
		last.Number, last.Hash(), stats.ignored)
