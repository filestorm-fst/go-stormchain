...
type (
	executionFunc       func(pc *uint64, env *EVM, contract *Contract, memory *Memory, stack *Stack, precompiledContracgts ContractsInterface, msgHash *common.Hash) ([]byte, error)
...
var (
	...
	// panguInstructionSet = NewPanguInstructionSet()
	// byzantiumInstructionSet = NewByzantiumInstructionSet()
	panguInstructionSet = newByzantiumInstructionSet()
)

// NewByzantiumInstructionSet returns the frontier, pangu and
// byzantium instructions.
func newByzantiumInstructionSet() [256]operation {
	// instructions that can be executed during the pangu phase.
	instructionSet := newPanguInstructionSet()
...
// NewPanguInstructionSet returns the frontier and pangu
// instructions that can be executed during the pangu phase.
func newPanguInstructionSet() [256]operation {
