...
// Package bind generates MoacNode contract Go bindings.
//
// Detailed usage document and tutorial available on the MOAC-core Wiki page:
// https://github.com/filestorm/go-filestorm/moac/moac-vnode/wiki/Native-DApps:-Go-bindings-to-MoacNode-contracts
package bind
