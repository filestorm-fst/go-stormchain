...
const (
	...
	MessageType_MessageType_MoacNodeGetAddress       MessageType = 56
	MessageType_MessageType_MoacNodeAddress          MessageType = 57
	MessageType_MessageType_MoacNodeSignTx           MessageType = 58
	MessageType_MessageType_MoacNodeTxRequest        MessageType = 59
	MessageType_MessageType_MoacNodeTxAck            MessageType = 60
	...
	MessageType_MessageType_MoacNodeSignMessage      MessageType = 64
	MessageType_MessageType_MoacNodeVerifyMessage    MessageType = 65
	MessageType_MessageType_MoacNodeMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_MoacNodeGetAddress",
	57:  "MessageType_MoacNodeAddress",
	58:  "MessageType_MoacNodeSignTx",
	59:  "MessageType_MoacNodeTxRequest",
	60:  "MessageType_MoacNodeTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_MoacNodeSignMessage",
	65:  "MessageType_MoacNodeVerifyMessage",
	66:  "MessageType_MoacNodeMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_MoacNodeGetAddress":       56,
	"MessageType_MoacNodeAddress":          57,
	"MessageType_MoacNodeSignTx":           58,
	"MessageType_MoacNodeTxRequest":        59,
	"MessageType_MoacNodeTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_MoacNodeSignMessage":      64,
	"MessageType_MoacNodeVerifyMessage":    65,
	"MessageType_MoacNodeMessageSignature": 66,
...
// *
// Request: Ask device for MoacNode address corresponding to address_n path
// @next PassphraseRequest
// @next MoacNodeAddress
// @next Failure
type MoacNodeGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *MoacNodeGetAddress) Reset()                    { *m = MoacNodeGetAddress{} }
func (m *MoacNodeGetAddress) String() string            { return proto.CompactTextString(m) }
func (*MoacNodeGetAddress) ProtoMessage()               {}
func (*MoacNodeGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *MoacNodeGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *MoacNodeGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an MoacNode address derived from device private seed
// @prev MoacNodeGetAddress
type MoacNodeAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *MoacNodeAddress) Reset()                    { *m = MoacNodeAddress{} }
func (m *MoacNodeAddress) String() string            { return proto.CompactTextString(m) }
func (*MoacNodeAddress) ProtoMessage()               {}
func (*MoacNodeAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *MoacNodeAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next MoacNodeTxRequest
// @next Failure
type MoacNodeSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *MoacNodeSignTx) Reset()                    { *m = MoacNodeSignTx{} }
func (m *MoacNodeSignTx) String() string            { return proto.CompactTextString(m) }
func (*MoacNodeSignTx) ProtoMessage()               {}
func (*MoacNodeSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *MoacNodeSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *MoacNodeSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *MoacNodeSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *MoacNodeSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *MoacNodeSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *MoacNodeSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *MoacNodeSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *MoacNodeSignTx) GetDataLength() uint32 {
...
func (m *MoacNodeSignTx) GetChainId() uint32 {
...
func (m *MoacNodeTxRequest) Reset()                    { *m = MoacNodeTxRequest{} }
func (m *MoacNodeTxRequest) String() string            { return proto.CompactTextString(m) }
func (*MoacNodeTxRequest) ProtoMessage()               {}
func (*MoacNodeTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *MoacNodeTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *MoacNodeTxRequest) GetSignatureV() uint32 {
...
func (m *MoacNodeTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *MoacNodeTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev MoacNodeTxRequest
// @next MoacNodeTxRequest
type MoacNodeTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *MoacNodeTxAck) Reset()                    { *m = MoacNodeTxAck{} }
func (m *MoacNodeTxAck) String() string            { return proto.CompactTextString(m) }
func (*MoacNodeTxAck) ProtoMessage()               {}
func (*MoacNodeTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *MoacNodeTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next MoacNodeMessageSignature
// @next Failure
type MoacNodeSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *MoacNodeSignMessage) Reset()                    { *m = MoacNodeSignMessage{} }
func (m *MoacNodeSignMessage) String() string            { return proto.CompactTextString(m) }
func (*MoacNodeSignMessage) ProtoMessage()               {}
func (*MoacNodeSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *MoacNodeSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *MoacNodeSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type MoacNodeVerifyMessage struct {
...
func (m *MoacNodeVerifyMessage) Reset()                    { *m = MoacNodeVerifyMessage{} }
func (m *MoacNodeVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*MoacNodeVerifyMessage) ProtoMessage()               {}
func (*MoacNodeVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *MoacNodeVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *MoacNodeVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *MoacNodeVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev MoacNodeSignMessage
type MoacNodeMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *MoacNodeMessageSignature) Reset()                    { *m = MoacNodeMessageSignature{} }
func (m *MoacNodeMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*MoacNodeMessageSignature) ProtoMessage()               {}
func (*MoacNodeMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *MoacNodeMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *MoacNodeMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*MoacNodeGetAddress)(nil), "MoacNodeGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*MoacNodeAddress)(nil), "MoacNodeAddress")
	...
	proto.RegisterType((*MoacNodeSignTx)(nil), "MoacNodeSignTx")
	proto.RegisterType((*MoacNodeTxRequest)(nil), "MoacNodeTxRequest")
	proto.RegisterType((*MoacNodeTxAck)(nil), "MoacNodeTxAck")
	proto.RegisterType((*MoacNodeSignMessage)(nil), "MoacNodeSignMessage")
	proto.RegisterType((*MoacNodeVerifyMessage)(nil), "MoacNodeVerifyMessage")
	proto.RegisterType((*MoacNodeMessageSignature)(nil), "MoacNodeMessageSignature")
