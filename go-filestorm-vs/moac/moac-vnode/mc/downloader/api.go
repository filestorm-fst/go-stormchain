...
// Syncing provides information when this nodes starts synchronising with the MoacNode network and when it's finished.
...
type SyncingResult struct {
	...
	Status  moaccore.SyncProgress `json:"status"`
}
