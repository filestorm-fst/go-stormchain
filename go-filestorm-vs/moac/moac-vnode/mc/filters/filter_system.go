...
// Package filters implements an moaccore filtering system for block,
...
func (es *EventSystem) eventLoop() {
	...
	var (
		...
		// Subscribe TxShardJoinEvent form txpool
		//txShard    = make(chan core.TxShardJoinEvent, txChanSize)
		//txShardSub = es.backend.SubscribeTxShardJoinEvent(txShard)
	...
	if sub == nil || txSub == nil || rmLogsSub == nil || logsSub == nil || chainEvSub == nil {
		log.Info("Subscribe for event system failed")
		return
	}
