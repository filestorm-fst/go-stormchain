...
fmt.Println("init the config with MarshalTOML", enc.Moacbase)
	return &enc, nil
}
...
fmt.Println("init the config with MarshalTOML", dec.Moacbase)
	return nil
}
