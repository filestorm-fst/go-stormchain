...
func newClientPool(db fstdb.Database, freeClientCap uint64, clock mclock.Clock, removePeer func(enode.ID)) *clientPool {
...
func newNodeDB(db fstdb.Database, clock mclock.Clock) *nodeDB {
