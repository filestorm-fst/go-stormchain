...
import (
	...
	"github.com/filestorm/go-filestorm/internal/cmdtest"
...
func init() {
	// Run the app if we've been exec'd as "storm-test" in runStorm.
...
func runStorm(t *testing.T, args ...string) *testgeth {
	tt := &testgeth{}
	...
	for i, arg := range args {
		...
		case arg == "-stormbase" || arg == "--stormbase":
			if i < len(args)-1 {
				tt.Stormbase = args[i+1]
			}
		}
	}
	if tt.Datadir == "" {
