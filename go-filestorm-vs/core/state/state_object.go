...
// stateObject represents an Filestorm account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of filestorm address of the account
	data     Account
	db       *StateDB
...
// Account is the Filestorm consensus representation of accounts.
