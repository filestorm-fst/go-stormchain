...
// account array.
func checkStateAccounts(t *testing.T, db fstdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db fstdb.Database, root common.Hash) error {
...
func checkStateConsistency(db fstdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(fstdb.Database), srcRoot)
