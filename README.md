...
对于在MOAC公链上发布一条应用链，可以通过在MOAC主网上发布一个智能合约[ApplicationChain.sol](https://github.com/filestorm-fst/go-stormchain/blob/master/solidity/ApplicationChain.sol)，然后生成创世文件。
