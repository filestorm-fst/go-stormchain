...
Audit reports are published in the `docs` folder: https://github.com/filestorm/go-filestorm/tree/master/docs/audits 


| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `storm` | 20170425 | [pdf](https://github.com/filestorm/go-filestorm/blob/master/docs/audits/2017-04-25_Storm-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/filestorm/go-filestorm/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |
...
To find out how to disclose a vulnerability in Filestorm visit [https://bounty.filestorm.org](https://bounty.filestorm.org) or email bounty@filestorm.org.
