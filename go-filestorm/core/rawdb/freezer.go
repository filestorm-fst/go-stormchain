...
//   reserving it for go-filestorm. This would also reduce the memory requirements
//   of Storm, and thus also GC overhead.
type freezer struct {
...
func (f *freezer) freeze(db fstdb.KeyValueStore) {
