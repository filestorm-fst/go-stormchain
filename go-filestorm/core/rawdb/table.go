...
func NewTable(db fstdb.Database, prefix string) fstdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator() fstdb.Iterator {
...
// not exist).
func (t *table) NewIteratorWithStart(start []byte) fstdb.Iterator {
	return t.db.NewIteratorWithStart(start)
}

// NewIteratorWithPrefix creates a binary-alphabetical iterator over a subset
// of database content with a particular key prefix.
func (t *table) NewIteratorWithPrefix(prefix []byte) fstdb.Iterator {
...
func (t *table) NewBatch() fstdb.Batch {
...
func (b *tableBatch) Replay(w fstdb.KeyValueWriter) error {
