...
func NewDatabase(db fstdb.KeyValueStore) fstdb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db fstdb.KeyValueStore, freezer string, namespace string) (fstdb.Database, error) {
...
func NewMemoryDatabase() fstdb.Database {
...
func NewMemoryDatabaseWithCap(size int) fstdb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string) (fstdb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string) (fstdb.Database, error) {
...
func InspectDatabase(db fstdb.Database) error {
	it := db.NewIterator()
	defer it.Release()
