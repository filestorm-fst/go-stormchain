...
// Package types contains data types related to Filestorm consensus.
package types
...
// Header represents a block header in the Filestorm blockchain.
type Header struct {
...
// Block represents an entire block in the Filestorm blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package fst to track
...
// [deprecated by fst/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for fst protocol, etc.
...
// DecodeRLP decodes the Filestorm
...
// EncodeRLP serializes b into the Filestorm RLP block format.
