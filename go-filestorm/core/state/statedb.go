...
// Package state provides a caching layer atop the Filestorm state trie.
package state
...
// StateDBs within the filestorm protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/filestorm/go-filestorm/pull/16485#issuecomment-380438527),
