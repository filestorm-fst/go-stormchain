...
// Whisper represents a dark communication interface through the Filestorm
...
// New creates a Whisper client ready to communicate through the Filestorm P2P network.
