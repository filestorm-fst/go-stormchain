...
// Package dpos implements the deligated proof of staking consensus engine.
package dpos
...
import (
	...
	"github.com/filestorm/go-filestorm/crypto/sha3"
	"github.com/filestorm/go-filestorm/ethdb"
...
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	copy(signer[:], crypto.Keccak256(pubkey[1:]))
