...
var (
	epochLength = uint64(36000) // Default number of blocks after which to checkpoint and reset the pending votes
...
// ecrecover extracts the Filestorm account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Filestorm address
...
type Pbft struct {
	...
	signer common.Address // Filestorm address of the signing key
...
func New(config *params.PbftConfig, db fstdb.Database) *Pbft {
...
// Author implements consensus.Engine, returning the Filestorm address recovered
...
// Close implements consensus.Engine. It's a noop for Pbft as there are no background threads.
