...
import (
	...
	"github.com/filestorm/go-filestorm/signer/storage"
)
...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*fstapi.SignTransactionResult, error)
...
type UIClientAPI interface {
	...
	OnApprovedTx(tx fstapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*fstapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := fstapi.SignTransactionResult{Raw: rlpdata, Tx: signedTx}
