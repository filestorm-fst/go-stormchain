...
// Package filestorm defines interfaces for interacting with Filestorm.
package filestorm
...
type FilterQuery struct {
	BlockHash *common.Hash     // used by fst_getLogs, return logs only from block with this hash
