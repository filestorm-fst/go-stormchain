...
var (
	...
	fstashChainConfig *params.ChainConfig
...
func init() {
	...
	fstashChainConfig = params.TestChainConfig
...
func newTestWorkerBackend(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, db fstdb.Database, n int) *testWorkerBackend {
...
func newTestWorker(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, db fstdb.Database, blocks int) (*worker, *testWorkerBackend) {
...
func TestGenerateBlockAndImportFstash(t *testing.T) {
...
func testGenerateBlockAndImport(t *testing.T, isClique bool) {
	...
	if isClique {
		...
		chainConfig = params.AllFstashProtocolChanges
...
func TestEmptyWorkFstash(t *testing.T) {
	testEmptyWork(t, fstashChainConfig, fstash.NewFaker())
}
...
func TestStreamUncleBlock(t *testing.T) {
	fstash := fstash.NewFaker()
	defer fstash.Close()

	w, b := newTestWorker(t, fstashChainConfig, fstash, rawdb.NewMemoryDatabase(), 1)
	defer w.close()
...
func TestRegenerateMiningBlockFstash(t *testing.T) {
	testRegenerateMiningBlock(t, fstashChainConfig, fstash.NewFaker())
}
...
func TestAdjustIntervalFstash(t *testing.T) {
	testAdjustInterval(t, fstashChainConfig, fstash.NewFaker())
}
