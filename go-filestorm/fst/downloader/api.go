...
// Syncing provides information when this nodes starts synchronising with the Filestorm network and when it's finished.
...
type SyncingResult struct {
	...
	Status  filestorm.SyncProgress `json:"status"`
}
