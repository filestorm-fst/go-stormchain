...
const protocolName = "fst"

// ProtocolVersions are the supported versions of the fst protocol (first is primary).
...
// statusData63 is the network packet for the status message for fst/63.
...
// statusData is the network packet for the status message for fst/64 and later.
