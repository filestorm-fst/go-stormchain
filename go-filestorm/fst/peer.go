...
// PeerInfo represents a short summary of the Filestorm sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Filestorm protocol version negotiated
...
// Handshake executes the fst protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("fst/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the Filestorm sub-protocol.
type peerSet struct {
