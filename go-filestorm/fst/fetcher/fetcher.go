...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (fst/61) or header (fst/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (fst/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both fst/61 and fst/62)
}
