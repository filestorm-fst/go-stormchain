...
// package web3ext contains storm specific web3.js extensions.
package web3ext
...
web3._extend({
	...
	methods: [
		...
		new web3._extend.Method({
			name: 'getHashrate',
			call: 'fstash_getHashrate',
			params: 0
		}),
		new web3._extend.Method({
			name: 'submitWork',
			call: 'fstash_submitWork',
			params: 3,
		}),
		new web3._extend.Method({
			name: 'submitHashRate',
			call: 'fstash_submitHashRate',
			params: 2,
		}),
	]
});
...
web3._extend({
	...
	methods: [
		...
		new web3._extend.Method({
			...
			call: 'fst_submitTransaction',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter]
		}),
		new web3._extend.Method({
			name: 'fillTransaction',
			call: 'fst_fillTransaction',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter]
		}),
		new web3._extend.Method({
			name: 'getHeaderByNumber',
			call: 'fst_getHeaderByNumber',
			params: 1
		}),
		new web3._extend.Method({
			name: 'getHeaderByHash',
			call: 'fst_getHeaderByHash',
			params: 1
		}),
		new web3._extend.Method({
			name: 'getBlockByNumber',
			call: 'fst_getBlockByNumber',
			params: 2
		}),
		new web3._extend.Method({
			name: 'getBlockByHash',
			call: 'fst_getBlockByHash',
			params: 2
		}),
		new web3._extend.Method({
			name: 'getRawTransaction',
			call: 'fst_getRawTransactionByHash',
			params: 1
		}),
		new web3._extend.Method({
			name: 'getRawTransactionFromBlock',
			call: function(args) {
				return (web3._extend.utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'fst_getRawTransactionByBlockHashAndIndex' : 'fst_getRawTransactionByBlockNumberAndIndex';
			},
			params: 2,
	...
	properties: [
		new web3._extend.Property({
			...
			getter: 'fst_pendingTransactions',
