 ...
 * @author Gary Rong<garyrong@filestorm.org>, Martin Swende <martin.swende@filestorm.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the filestorm.
    uint sectionSize;
