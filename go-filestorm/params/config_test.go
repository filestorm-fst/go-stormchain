...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllFstashProtocolChanges, new: AllFstashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllFstashProtocolChanges, new: AllFstashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllFstashProtocolChanges,
