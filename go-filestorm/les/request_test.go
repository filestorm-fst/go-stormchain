...
type accessTestFn func(db fstdb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }
func TestBlockAccessLes3(t *testing.T) { testAccess(t, 3, tfBlockAccess) }

func tfBlockAccess(db fstdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db fstdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db fstdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db fstdb.Database, bhash common.Hash, num uint64) light.OdrRequest {
