...
import (
	...
	math2 "github.com/filestorm/go-filestorm/common/math"
...
// newAlethGenesisSpec converts a go-filestorm genesis block into a Aleth-specific
// chain specification format.
func newAlethGenesisSpec(network string, genesis *core.Genesis) (*alethGenesisSpec, error) {
	// Only fstash is currently supported between go-filestorm and aleth
	if genesis.Config.Fstash == nil {
	...
	spec.Params.BlockReward = (*hexutil.Big)(fstash.FrontierBlockReward)
...
type parityChainSpecPricing struct {
	...
	// Before the https://github.com/paritytech/parity-filestorm/pull/11039,
...
// newParityChainSpec converts a go-filestorm genesis block into a Parity specific
// chain specification format.
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	// Only fstash is currently supported between go-filestorm and Parity
	if genesis.Config.Fstash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
	...
	spec.Engine.Fstash.Params.BlockReward = make(map[string]string)
	spec.Engine.Fstash.Params.DifficultyBombDelays = make(map[string]string)
	// Frontier
	spec.Engine.Fstash.Params.MinimumDifficulty = (*hexutil.Big)(params.MinimumDifficulty)
	spec.Engine.Fstash.Params.DifficultyBoundDivisor = (*hexutil.Big)(params.DifficultyBoundDivisor)
	spec.Engine.Fstash.Params.DurationLimit = (*hexutil.Big)(params.DurationLimit)
	spec.Engine.Fstash.Params.BlockReward["0x0"] = hexutil.EncodeBig(fstash.FrontierBlockReward)

	// Homestead
	spec.Engine.Fstash.Params.HomesteadTransition = hexutil.Uint64(genesis.Config.HomesteadBlock.Uint64())

	// Tangerine Whistle : 150
	// https://github.com/filestorm/EIPs/blob/master/EIPS/eip-608.md
	spec.Params.EIP150Transition = hexutil.Uint64(genesis.Config.EIP150Block.Uint64())

	// Spurious Dragon: 155, 160, 161, 170
	// https://github.com/filestorm/EIPs/blob/master/EIPS/eip-607.md
	...
	// storm has it set from zero
	spec.Params.MaxCodeSizeTransition = 0

	// Disable this one
	spec.Params.EIP98Transition = math.MaxInt64

	spec.Genesis.Seal.Filestorm.Nonce = types.EncodeNonce(genesis.Nonce)
	spec.Genesis.Seal.Filestorm.MixHash = (genesis.Mixhash[:])
	spec.Genesis.Difficulty = (*hexutil.Big)(genesis.Difficulty)
	spec.Genesis.Author = genesis.Coinbase
	spec.Genesis.Timestamp = (hexutil.Uint64)(genesis.Timestamp)
	spec.Genesis.ParentHash = genesis.ParentHash
...
func (spec *parityChainSpec) setByzantium(num *big.Int) {
	spec.Engine.Fstash.Params.BlockReward[hexutil.EncodeBig(num)] = hexutil.EncodeBig(fstash.ByzantiumBlockReward)
	spec.Engine.Fstash.Params.DifficultyBombDelays[hexutil.EncodeBig(num)] = hexutil.EncodeUint64(3000000)
	n := hexutil.Uint64(num.Uint64())
	spec.Engine.Fstash.Params.EIP100bTransition = n
...
func (spec *parityChainSpec) setConstantinople(num *big.Int) {
	spec.Engine.Fstash.Params.BlockReward[hexutil.EncodeBig(num)] = hexutil.EncodeBig(fstash.ConstantinopleBlockReward)
	spec.Engine.Fstash.Params.DifficultyBombDelays[hexutil.EncodeBig(num)] = hexutil.EncodeUint64(2000000)
	n := hexutil.Uint64(num.Uint64())
...
// pyFilestormGenesisSpec represents the genesis specification format used by the
// Python Filestorm implementation.
type pyFilestormGenesisSpec struct {
	Nonce      types.BlockNonce  `json:"nonce"`
	Timestamp  hexutil.Uint64    `json:"timestamp"`
	ExtraData  hexutil.Bytes     `json:"extraData"`
	GasLimit   hexutil.Uint64    `json:"gasLimit"`
...
// newPyFilestormGenesisSpec converts a go-filestorm genesis block into a Parity specific
// chain specification format.
func newPyFilestormGenesisSpec(network string, genesis *core.Genesis) (*pyFilestormGenesisSpec, error) {
	// Only fstash is currently supported between go-filestorm and pyfilestorm
	if genesis.Config.Fstash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
	spec := &pyFilestormGenesisSpec{
