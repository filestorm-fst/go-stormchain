...
func (w *wizard) makeGenesis() {
	...
	fmt.Println(" 1. Fstash - proof-of-work")
	fmt.Println(" 2. Clique - proof-of-authority")

	choice := w.read()
	switch {
	case choice == "1":
		// In case of fstash, we're pretty much done
		genesis.Config.Fstash = new(params.FstashConfig)
...
// importGenesis imports a Storm genesis spec into puppeth.
...
func (w *wizard) manageGenesis() {
	...
	case "2":
		...
		// Export the native genesis spec used by puppeth and Storm
		...
		// Export the genesis spec used by Aleth (formerly C++ Filestorm)
		...
		// Export the genesis spec used by Harmony (formerly FilestormJ)
