...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Filestorm presale wallets",
		ArgsUsage: "",
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Filestorm presale wallet",
				ArgsUsage: "<keyFile>",
...
between filestorm nodes by simply copying.
...
Note:
As you can directly copy your encrypted accounts to another filestorm instance,
