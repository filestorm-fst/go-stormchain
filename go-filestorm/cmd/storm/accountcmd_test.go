...
func TestAccountListEmpty(t *testing.T) {
	storm := runStorm(t, "account", "list")
	storm.ExpectExit()
}

func TestAccountList(t *testing.T) {
	datadir := tmpDatadirWithKeystore(t)
	storm := runStorm(t, "account", "list", "--datadir", datadir)
...
func TestAccountNew(t *testing.T) {
	storm := runStorm(t, "account", "new", "--lightkdf")
	defer storm.ExpectExit()
	storm.Expect(`
...
func TestAccountUpdate(t *testing.T) {
	datadir := tmpDatadirWithKeystore(t)
	storm := runStorm(t, "account", "update",
...
func TestWalletImport(t *testing.T) {
	storm := runStorm(t, "wallet", "import", "--lightkdf", "testdata/guswallet.json")
	defer storm.ExpectExit()
	storm.Expect(`
!! Unsupported terminal, password will be echoed.
...
// https://github.com/filestorm/go-filestorm/issues/1785
