...
import (
	...
	"github.com/filestorm/go-filestorm/cmd/evm/internal/compiler"
	...
	"github.com/filestorm/go-filestorm/core/vm/runtime"
...
func runCmd(ctx *cli.Context) error {
	...
	if chainConfig != nil {
		...
		runtimeConfig.ChainConfig = params.AllFstashProtocolChanges
	}
	tstart := time.Now()
