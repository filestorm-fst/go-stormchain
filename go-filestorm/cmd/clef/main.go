...
import (
	...
	"github.com/filestorm/go-filestorm/signer/fourbyte"
	"github.com/filestorm/go-filestorm/signer/rules"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Filestorm account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
...
func GenDoc(ctx *cli.Context) {
	...
	{ // WHen a signed tx is ready to go out
		...
		add("OnApproved - SignTransactionResult", desc, &fstapi.SignTransactionResult{Raw: rlpdata, Tx: &tx})
