...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Filestorm address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Filestorm account at a particular block.
    type Account {
    ...
    # Transaction is an Filestorm transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Filestorm account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an Filestorm account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Filestorm block by number or by hash. If neither is
