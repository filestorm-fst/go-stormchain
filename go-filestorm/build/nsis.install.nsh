Name "storm ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/filestorm/go-filestorm/issues"
!define UPDATEURL "https://github.com/filestorm/go-filestorm/releases"
!define ABOUTURL "https://github.com/filestorm/go-filestorm#filestorm-go"
...
# Install storm binary
Section "Storm" STORM_IDX
  SetOutPath $INSTDIR
  file {{.Storm}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\storm.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\storm.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Storm incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Storm outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Storm UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Storm incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\storm.exe" "" "" "Filestorm" 30303 "" "" ""
  SimpleFC::AdvAddRule "Storm outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\storm.exe" "" "" "Filestorm" "" 30303 "" ""
  SimpleFC::AdvAddRule "Storm UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\storm.exe" "" "" "Filestorm" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/filestorm/EIPs/issues/147)
  ${EnvVarUpdate} $0 "FILESTORM_SOCKET" "R" "HKLM" "\\.\pipe\storm.ipc"
  ${EnvVarUpdate} $0 "FILESTORM_SOCKET" "A" "HKLM" "\\.\pipe\storm.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${STORM_IDX}
    SectionGetSize ${STORM_IDX} $0
