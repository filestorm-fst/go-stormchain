...
# 1. install storm for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for storm
# 5. create storm, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable FILESTORM_SOCKET
...
!define GROUPNAME "Filestorm"
!define APPNAME "Storm"
!define DESCRIPTION "Official Go implementation of the Filestorm protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since storm is installed global
