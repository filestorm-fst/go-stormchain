...
creating a collection of devp2p nodes, connecting them tostormer to form a
...
connecting two nodes tostormer).
...
As a concrete example, consider a simulated network of StormChain nodes. An
