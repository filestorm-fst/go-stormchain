...
import (
	...
	"github.com/filestorm-fst/go-stormchain/consensus/misc"
...
var (
	...
	retestethCommand = cli.Command{
		...
		Name:        "retesteth",
		Usage:       "Launches storm in retesteth mode",
		ArgsUsage:   "",
		Flags:       []cli.Flag{rpcPortFlag},
		Category:    "MISCELLANEOUS COMMANDS",
		Description: `Launches storm in retesteth mode (no database, no network, only retesteth RPC interface)`,
	}
)
...
func retesteth(ctx *cli.Context) error {
	...
	listener, _, err := rpc.StartHTTPEndpoint(httpEndpoint, rpcAPI, []string{"test", "storm", "debug", "web3"}, cors, vhosts, rpc.DefaultHTTPTimeouts)
	if err != nil {
