...
// Package core implements the StormChain consensus protocol.
package core
...
type CacheConfig struct {
	...
	TrieDirtyDisabled   bool          // Whether to disable trie write caching and GC altostormer (archive node)
...
// available in the database. It initialises the default StormChain Validator and
// Processor.
