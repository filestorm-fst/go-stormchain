...
// Package state provides a caching layer atop the StormChain state trie.
package state
...
// StateDBs within the stormchain protocol are used to store anything
...
//
// Carrying over the balance ensures that Storm doesn't disappear.
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/filestorm-fst/go-stormchain/pull/16485#issuecomment-380438527),
