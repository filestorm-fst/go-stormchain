...
// all blocks' seal as valid, though they still have to conform to the StormChain
// consensus rules.
...
// still have to conform to the StormChain consensus rules.
...
// they still have to conform to the StormChain consensus rules.
...
func (ethash *Ethash) APIs(chain consensus.ChainReader) []rpc.API {
	...
	// to both storm and ethash namespaces.
	return []rpc.API{
		{
			Namespace: "storm",
			Version:   "1.0",
