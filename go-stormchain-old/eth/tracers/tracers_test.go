...
import (
	...
	"github.com/filestorm-fst/go-stormchain/tests"
)
...
var makeTest = function(tx, rewind) {
  ...
  var block   = storm.getBlock(storm.getTransaction(tx).blockHash);
  var genesis = storm.getBlock(block.parentHash);
  ...
  genesis.config = admin.nodeInfo.protocols.storm.config;
  ...
  console.log(JSON.stringify({
    ...
    input:  storm.getRawTransaction(tx),
    result: result,
  }, null, 2));
}
*/
