...
// PeerInfo represents a short summary of the StormChain sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // StormChain protocol version negotiated
...
// Handshake executes the storm protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("storm/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the StormChain sub-protocol.
type peerSet struct {
