...
const protocolName = "storm"

// ProtocolVersions are the supported versions of the storm protocol (first is primary).
...
// statusData63 is the network packet for the status message for storm/63.
...
// statusData is the network packet for the status message for storm/64 and later.
