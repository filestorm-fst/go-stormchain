...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte StormChain address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an StormChain account at a particular block.
    type Account {
    ...
    # Log is an StormChain event log.
    type Log {
    ...
    # Transaction is an StormChain transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an StormChain account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an StormChain account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an StormChain block by number or by hash. If neither is
