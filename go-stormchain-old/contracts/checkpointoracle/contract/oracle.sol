 ...
 * @author Gary Rong<garyrong@stormchain.org>, Martin Swende <martin.swende@stormchain.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the stormchain.
    uint sectionSize;
