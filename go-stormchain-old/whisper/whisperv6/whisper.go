...
// Whisper represents a dark communication interface through the StormChain
...
// New creates a Whisper client ready to communicate through the StormChain P2P network.
