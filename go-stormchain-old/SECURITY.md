...
Audit reports are published in the `docs` folder: https://github.com/filestorm-fst/go-stormchain/tree/master/docs/audits 


| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `storm` | 20170425 | [pdf](https://github.com/filestorm-fst/go-stormchain/blob/master/docs/audits/2017-04-25_Geth-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/filestorm-fst/go-stormchain/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |
...
To find out how to disclose a vulnerability in StormChain visit [https://bounty.stormchain.org](https://bounty.stormchain.org) or email bounty@stormchain.org.
