...
// Package bind generates StormChain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-stormchain Wiki page:
// https://github.com/filestorm-fst/go-stormchain/wiki/Native-DApps:-Go-bindings-to-StormChain-contracts
package bind
...
func bindStructTypeGo(kind abi.Type, structs map[string]*tmplStruct) string {
	...
	case abi.TupleTy:
		...
		// tostormer here. The reason is before solidity v0.5.11, kind.TupleRawName
		// is empty, so we use canonical parameter expression to distinguish
		// different struct definition. From the consideration of backward
		// compatibility, we concat these two tostormer so that if kind.TupleRawName
