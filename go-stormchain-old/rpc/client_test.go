...
// This test reproduces https://github.com/filestorm-fst/go-stormchain/issues/17837 where the
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-stormchain-test-ipc-%d-%d", os.Getpid(), rand.Int63())
